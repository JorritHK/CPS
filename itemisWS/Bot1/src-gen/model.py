...
class Model:
    ...
    def is_active(self):
        ...
        return (
            self.__state_vector[0] is not self.__State.null_state
            or self.__state_vector[1] is not self.__State.null_state
        )
    ...
    def is_state_active(self, state):
        ...
        if s == self.__State.main_region_test:
            return (
                self.__state_vector[0] >= self.__State.main_region_test
            ) and (
                self.__state_vector[0]
                <= self.__State.main_region_test_logging_grid_start
            )
        if s == self.__State.main_region_test_drive_main:
            return (
                self.__state_vector[0]
                >= self.__State.main_region_test_drive_main
            ) and (
                self.__state_vector[0]
                <= self.__State.main_region_test_drive_main_r1calibration_r1waiting
            )
        if s == self.__State.main_region_test_drive_main_r1stopped:
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1stopped
            )
        if s == self.__State.main_region_test_drive_main_r1manual:
            return (
                self.__state_vector[0]
                >= self.__State.main_region_test_drive_main_r1manual
            ) and (
                self.__state_vector[0]
                <= self.__State.main_region_test_drive_main_r1manual_r1rotations_r1incr__rot__speed_left
            )
        if s == self.__State.main_region_test_drive_main_r1manual_r1speed:
            return (
                self.__state_vector[0]
                >= self.__State.main_region_test_drive_main_r1manual_r1speed
            ) and (
                self.__state_vector[0]
                <= self.__State.main_region_test_drive_main_r1manual_r1speed_r1decrease_speed
            )
        if (
            s
            == self.__State.main_region_test_drive_main_r1manual_r1speed_r1increase_speed
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1manual_r1speed_r1increase_speed
        ...
        if s == self.__State.main_region_test_drive_main_r1manual_r1rotations:
            return (
                self.__state_vector[0]
                >= self.__State.main_region_test_drive_main_r1manual_r1rotations
            ) and (
                self.__state_vector[0]
                <= self.__State.main_region_test_drive_main_r1manual_r1rotations_r1incr__rot__speed_left
            )
        if (
            s
            == self.__State.main_region_test_drive_main_r1manual_r1rotations_r1incr__rot__speed_right
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1manual_r1rotations_r1incr__rot__speed_right
        ...
        if s == self.__State.main_region_test_drive_main_r1automatic_mode:
            return (
                self.__state_vector[0]
                >= self.__State.main_region_test_drive_main_r1automatic_mode
            ) and (
                self.__state_vector[0]
                <= self.__State.main_region_test_drive_main_r1automatic_mode_r2overrides_pitchcorrect
            )
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left
        ):
            return (
                self.__state_vector[0]
                >= self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left
                ...
                self.__state_vector[0]
                <= self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_around
            )
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1calibrate
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1calibrate
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1finished_calibration
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1finished_calibration
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1forward
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1forward
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_right
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_right
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1forward_stop
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1forward_stop
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_stop
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_stop
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turning_to_target
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turning_to_target
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_left
        ):
            return (
                self.__state_vector[0]
                == self.__State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_left
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_r2overrides
        ):
            return (
                self.__state_vector[1]
                >= self.__State.main_region_test_drive_main_r1automatic_mode_r2overrides
            ) and (
                self.__state_vector[1]
                <= self.__State.main_region_test_drive_main_r1automatic_mode_r2overrides_pitchcorrect
        ...
        if (
            s
            == self.__State.main_region_test_drive_main_r1automatic_mode_r2overrides_lidaridle
        ):
            return (
                self.__state_vector[1]
                == self.__State.main_region_test_drive_main_r1automatic_mode_r2overrides_lidaridle
        ...
        if (
            ...
            return (
                self.__state_vector[2]
                == self.__State.main_region_test_drive_main_r1automatic_mode_r2overrides_pitchcorrect
            )
        if s == self.__State.main_region_test_logging_grid_record:
            return (
                self.__state_vector[3]
                >= self.__State.main_region_test_logging_grid_record
            ) and (
                self.__state_vector[3]
                <= self.__State.main_region_test_logging_grid_record_r1_final_
            )
        if (
            s
            == self.__State.main_region_test_logging_grid_record_r1start_record
        ):
            return (
                self.__state_vector[1]
                == self.__State.main_region_test_logging_grid_record_r1start_record
        ...
        if s == self.__State.main_region_test_logging_grid_check_status:
            return (
                self.__state_vector[3]
                == self.__State.main_region_test_logging_grid_check_status
            )
    ...
    def __entry_action_main_region_test_drive_main_r1_stopped(self):
        ...
        self.output.speed = 0.0
        self.output.rotation = 0.0
        self.internal_operation_callback.debug("In stopped manual state")

    def __entry_action_main_region_test_drive_main_r1_manual_r1_speed_r1_increase_speed(
        self,
    ):
    ...
    def __entry_action_main_region_test_drive_main_r1_manual_r1_speed_r1_decrease_speed(
        self,
    ):
    ...
    def __entry_action_main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_right(
        self,
    ):
    ...
    def __entry_action_main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_left(
        self,
    ):
    ...
    def __entry_action_main_region_test_drive_main_r1_calibration_r1_calibrate(
        self,
    ):
        """."""
        ...
        self.internal_operation_callback.debug_bool(
            "setZero:", self.start_pos.set_zero
        )
        self.__completed = True

    def __entry_action_main_region_test_drive_main_r1_calibration_r1_finished_calibration(
        self,
    ):
        """."""
        # Entry action for state 'finished calibration'.
        self.internal_operation_callback.set_calibration(
            self.start_pos.zero_x,
            self.start_pos.zero_y,
            self.start_pos.zero_south_degree,
            self.start_pos.laser_deg_offset,
        )
        self.raise_has_calibrated()
        self.internal_operation_callback.debug("Has Calibrated")

    def __entry_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward(
        self,
    ):
    ...
    def __entry_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_right(
        self,
    ):
        ...
        self.grid.orientation = (
            self.internal_operation_callback.calc_orientation(self.imu.yaw)
        )
        self.user_var.target_yaw = (
            self.internal_operation_callback.orientation_to_yaw(
                (((self.grid.orientation + 1)) % 4)
            )
        )
        self.user_var.rotation_direction = -(1)
        self.user_var.yaw_to_go = 90
        self.internal_operation_callback.debug("Turning right")
        self.internal_operation_callback.debug_real(
            "Current yaw", (self.imu.yaw - self.start_pos.zero_south_degree)
        )
        self.internal_operation_callback.debug_real(
            "Target yaw is going to be", self.user_var.target_yaw
        )

    def __entry_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward_stop(
        self,
    ):
        ...
        self.grid.wall_front = (
            self.internal_operation_callback.direction_has_wall(
                self.laser_distance.d0
            )
        )
        self.grid.wall_left = (
            self.internal_operation_callback.direction_has_wall(
                self.laser_distance.d90
            )
        )
        self.grid.wall_back = (
            self.internal_operation_callback.direction_has_wall(
                self.laser_distance.d180
            )
        )
        self.grid.wall_right = (
            self.internal_operation_callback.direction_has_wall(
                self.laser_distance.dm90
            )
        )

    def __entry_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_stop(
        self,
    ):
    ...
    def __entry_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turning_to_target(
        self,
    ):
    ...
    def __entry_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_left(
        self,
    ):
        ...
        self.internal_operation_callback.debug_real(
            "Zero south degree", self.start_pos.zero_south_degree
        )
        self.internal_operation_callback.debug_real(
            "Current yaw", self.imu.yaw
        )
        self.internal_operation_callback.debug_real(
            "Target yaw", self.user_var.target_yaw
        )

    def __entry_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_around(
        self,
    ):
    ...
    def __entry_action_main_region_test_logging_grid_record_r1_start_record(
        self,
    ):
        ...
        self.internal_operation_callback.debug_real(
            "wallFront", self.grid.wall_front
        )
        self.internal_operation_callback.debug_real(
            "wallRight", self.grid.wall_right
        )
        self.internal_operation_callback.debug_real(
            "wallBack", self.grid.wall_back
        )
        self.internal_operation_callback.debug_real(
            "wallLeft", self.grid.wall_left
        )
    ...
    def __exit_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_calibrate(
        self,
    ):
    ...
    def __exit_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_right(
        self,
    ):
    ...
    def __exit_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turning_to_target(
        self,
    ):
    ...
    def __exit_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_left(
        self,
    ):
    ...
    def __exit_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_around(
        self,
    ):
    ...
    def __exit_action_main_region_test_logging_grid_record_r1_start_record(
        self,
    ):
    ...
    def __enter_sequence_main_region_test_drive_main_r1_stopped_default(self):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1stopped
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1_increase_speed_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1manual_r1speed_r1increase_speed
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1_decrease_speed_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1manual_r1speed_r1decrease_speed
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_right_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1manual_r1rotations_r1incr__rot__speed_right
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_left_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1manual_r1rotations_r1incr__rot__speed_left
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_calibration_default(
        self,
    ):
        """'default' enter sequence for state Calibration."""
        #'default' enter sequence for state Calibration
        self.__enter_sequence_main_region_test_drive_main_r1_calibration_r1_default()

    def __enter_sequence_main_region_test_drive_main_r1_calibration_r1_calibrate_default(
        self,
    ):
        """'default' enter sequence for state calibrate."""
        #'default' enter sequence for state calibrate
        self.__entry_action_main_region_test_drive_main_r1_calibration_r1_calibrate()
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1calibration_r1calibrate
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_calibration_r1_finished_calibration_default(
        self,
    ):
        """'default' enter sequence for state finished calibration."""
        #'default' enter sequence for state finished calibration
        self.__entry_action_main_region_test_drive_main_r1_calibration_r1_finished_calibration()
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1calibration_r1finished_calibration
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1forward
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_right_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_right
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward_stop_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1forward_stop
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_stop_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_stop
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turning_to_target_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turning_to_target
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_left_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_left
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_around_default(
        self,
    ):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1turn_around
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_r2_overrides_default(
        self,
    ):
    ...
    def __enter_sequence_main_region_test_drive_main_r1_automatic_mode_r2_overrides_lidar_idle_default(
        self,
    ):
        """'default' enter sequence for state idle."""
        #'default' enter sequence for state waiting
        self.__entry_action_main_region_test_drive_main_r1_calibration_r1_waiting()
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1calibration_r1waiting
        )
        self.__state_conf_vector_position = 0
        self.__state_conf_vector_changed = True
    ...
    def __enter_sequence_main_region_test_logging_grid_record_r1_start_record_default(
        self,
    ):
        ...
        self.__state_vector[3] = (
            self.State.main_region_test_logging_grid_record_r1start_record
        )
        self.__state_conf_vector_position = 3
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_logging_grid_record_r1__final__default(
        self,
    ):
        ...
        self.__state_vector[3] = (
            self.State.main_region_test_logging_grid_record_r1_final_
        )
        self.__state_conf_vector_position = 3
        self.__state_conf_vector_changed = True

    def __enter_sequence_main_region_test_logging_grid_check_status_default(
        self,
    ):
        ...
        self.__state_vector[3] = (
            self.State.main_region_test_logging_grid_check_status
        )
        self.__state_conf_vector_position = 3
        self.__state_conf_vector_changed = True
    ...
    def __enter_sequence_main_region_test_drive_main_r1_calibration_r1_default(
        self,
    ):
        """'default' enter sequence for region r1."""
        #'default' enter sequence for region r1
        self.__react_main_region_test_drive_main_r1_calibration_r1__entry_default()
    ...
    def __exit_sequence_main_region_test_drive_main(self):
        """Default exit sequence for state Main."""
        # Default exit sequence for state Main
        self.__exit_sequence_main_region_test_drive_main_r1()
        self.__state_vector[0] = self.State.main_region_test
        self.__state_conf_vector_position = 0
    ...
    def __exit_sequence_main_region_test_drive_main_r1_manual_r1_speed(self):
        ...
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1manual
        )
        self.__state_conf_vector_position = 0

    def __exit_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1_increase_speed(
        self,
    ):
        """Default exit sequence for state Increase speed."""
        # Default exit sequence for state Increase speed
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1manual_r1speed
        )
        self.__state_conf_vector_position = 0

    def __exit_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1_decrease_speed(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_manual_r1_rotations(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_right(
        self,
    ):
        """Default exit sequence for state Incr. rot. speed right."""
        # Default exit sequence for state Incr. rot. speed right
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1manual_r1rotations
        )
        self.__state_conf_vector_position = 0

    def __exit_sequence_main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_left(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_calibration(self):
        """Default exit sequence for state Calibration."""
        # Default exit sequence for state Calibration
        self.__exit_sequence_main_region_test_drive_main_r1_calibration_r1()
        self.__state_vector[0] = self.State.main_region_test_drive_main
        self.__state_conf_vector_position = 0

    def __exit_sequence_main_region_test_drive_main_r1_calibration_r1_calibrate(
        self,
    ):
        """Default exit sequence for state calibrate."""
        # Default exit sequence for state calibrate
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1calibration
        )
        self.__state_conf_vector_position = 0
        self.__exit_action_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_calibrate()

    def __exit_sequence_main_region_test_drive_main_r1_calibration_r1_finished_calibration(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward(
        self,
    ):
        """Default exit sequence for state Forward."""
        # Default exit sequence for state Forward
        self.__state_vector[0] = (
            self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left
        )
        self.__state_conf_vector_position = 0

    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_right(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward_stop(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_stop(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turning_to_target(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_left(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_around(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_r2_overrides_lidar_idle(
        self,
    ):
        ...
        self.__state_conf_vector_position = 0
        self.__exit_action_main_region_test_drive_main_r1_calibration_r1_waiting()
    ...
    def __exit_sequence_main_region_test_logging_grid_record(self):
        ...
        self.__state_vector[1] = self.State.main_region_test
        self.__state_conf_vector_position = 1

    def __exit_sequence_main_region_test_logging_grid_record_r1_start_record(
        self,
    ):
        """Default exit sequence for state start record."""
        # Default exit sequence for state start record
        self.__state_vector[3] = (
            self.State.main_region_test_logging_grid_record
        )
        self.__state_conf_vector_position = 3
    ...
    def __exit_sequence_main_region(self):
        ...
        if state == self.State.main_region_test_drive_main:
            self.__exit_sequence_main_region_test_drive_main()
        elif state == self.State.main_region_test_drive_main_r1stopped:
            ...
            state
            == self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1calibrate
        ):
            self.__exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_calibrate()
        elif (
            state
            == self.State.main_region_test_drive_main_r1automatic_mode_automatic_algorithm_follow_left_r1finished_calibration
        ):
        ...
        if state == self.State.main_region_test_logging_grid_record:
            ...
            state == self.State.main_region_test_logging_grid_record_r1_final_
        ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1(
        self,
    ):
        """Default exit sequence for region r1."""
        # Default exit sequence for region r1
    ...
    def __exit_sequence_main_region_test_drive_main_r1_manual_r1_rotations_r1(
        self,
    ):
        """Default exit sequence for region r1."""
        # Default exit sequence for region r1
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm(
        self,
    ):
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1(
        self,
    ):
        """Default exit sequence for region r1."""
        # Default exit sequence for region r1
    ...
    def __exit_sequence_main_region_test_drive_main_r1_automatic_mode_r2(self):
        ...
        if (
            state
            == self.State.main_region_test_drive_main_r1automatic_mode_r2overrides_lidaridle
        ):
            self.__exit_sequence_main_region_test_drive_main_r1_automatic_mode_r2_overrides_lidar_idle()
        state = self.__state_vector[2]
        if (
            state
            == self.State.main_region_test_drive_main_r1automatic_mode_r2overrides_pitchcorrect
        ):
    ...
    def __react_main_region_test_drive_main_r1__entry_default(self):
        """Default react sequence for initial entry ."""
        # Default react sequence for initial entry
        self.__enter_sequence_main_region_test_drive_main_r1_calibration_default()

    def __react_main_region_test_drive_main_r1_calibration_r1__entry_default(
        self,
    ):
        """Default react sequence for initial entry ."""
        # Default react sequence for initial entry
        self.__enter_sequence_main_region_test_drive_main_r1_calibration_r1_calibrate_default()
    ...
    def __main_region_test_drive_main_r1_stopped_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            ...
            if transitioned_after == transitioned_before:
                ...
                transitioned_after = self.__main_region_test_drive_main_react(
                    transitioned_before
                )
        return transitioned_after

    def __main_region_test_drive_main_r1_manual_react(
        self, transitioned_before
    ):
    ...
    def __main_region_test_drive_main_r1_manual_r1_speed_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            ...
            if transitioned_after == transitioned_before:
                # then execute local reactions.
                transitioned_after = (
                    self.__main_region_test_drive_main_r1_manual_react(
                        transitioned_before
                    )
                )
        return transitioned_after

    def __main_region_test_drive_main_r1_manual_r1_speed_r1_increase_speed_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            if transitioned_after < 0:
                if (self.computer.w_press) and (
                    self.output.speed
                    < (self.base_values.max_speed - self.user_var.base_speed)
                ):
                    self.__exit_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1_increase_speed()
                    self.__enter_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1_increase_speed_default()
                    self.__main_region_test_drive_main_r1_manual_r1_speed_react(
                        0
                    )
                    transitioned_after = 0
                elif self.computer.x_press:
            ...
            if transitioned_after == transitioned_before:
                # then execute local reactions.
                transitioned_after = self.__main_region_test_drive_main_r1_manual_r1_speed_react(
                    transitioned_before
                )
        return transitioned_after

    def __main_region_test_drive_main_r1_manual_r1_speed_r1_decrease_speed_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            if transitioned_after < 0:
                if (self.computer.x_press) and (
                    self.output.speed
                    > (
                        -(self.base_values.max_speed)
                        + self.user_var.base_speed
                    )
                ):
                    self.__exit_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1_decrease_speed()
                    self.__enter_sequence_main_region_test_drive_main_r1_manual_r1_speed_r1_decrease_speed_default()
    ...
    def __main_region_test_drive_main_r1_manual_r1_rotations_react(
        self, transitioned_before
    ):
    ...
    def __main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_right_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            if transitioned_after < 0:
                if (self.computer.d_press) and (
                    self.output.rotation
                    > (
                        -(self.base_values.max_rotation)
                        + self.user_var.base_rotation
                    )
                ):
                    self.__exit_sequence_main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_right()
                    self.__enter_sequence_main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_right_default()
                    self.__main_region_test_drive_main_r1_manual_r1_rotations_react(
                        0
                    )
                    transitioned_after = 0
                elif self.computer.a_press:
            ...
            if transitioned_after == transitioned_before:
                # then execute local reactions.
                transitioned_after = self.__main_region_test_drive_main_r1_manual_r1_rotations_react(
                    transitioned_before
                )
        return transitioned_after

    def __main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_left_react(
        self, transitioned_before
    ):
    ...
    def __main_region_test_drive_main_r1_calibration_react(
        self, transitioned_before
    ):
        """Implementation of __main_region_test_drive_main_r1_calibration_react function."""
    ...
    def __main_region_test_drive_main_r1_calibration_r1_calibrate_react(
        self, transitioned_before
    ):
        """Implementation of __main_region_test_drive_main_r1_calibration_r1_calibrate_react function."""
        ...
        if not self.__do_completion:
            if transitioned_after < 0:
                if (self.__time_events[0]) and (not self.start_pos.set_zero):
                    ...
                    self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_react(
                        0
                    )
                    transitioned_after = 0
            ...
            if transitioned_after == transitioned_before:
                # then execute local reactions.
                transitioned_after = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_react(
                    transitioned_before
                )
        return transitioned_after

    def __main_region_test_drive_main_r1_calibration_r1_finished_calibration_react(
        self, transitioned_before
    ):
        """Implementation of __main_region_test_drive_main_r1_calibration_r1_finished_calibration_react function."""
    ...
    def __main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            if transitioned_after < 0:
                if (
                    self.laser_distance.dfront_mean
                    <= self.user_var.min_wall_turn
                ):
                    self.__exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward()
    ...
    def __main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_right_react(
        self, transitioned_before
    ):
    ...
    def __main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward_stop_react(
        self, transitioned_before
    ):
    ...
    def __main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_stop_react(
        self, transitioned_before
    ):
    ...
    def __main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turning_to_target_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            if transitioned_after < 0:
                if self.user_var.yaw_to_go < self.user_var.yaw_error:
                    self.__exit_sequence_main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turning_to_target()
                    self.internal_operation_callback.debug_real(
                        "Yaw to go", self.user_var.yaw_to_go
                    )
            ...
            if transitioned_after == transitioned_before:
                ...
                if self.__time_events[3]:
                    self.__calibrated_yaw = (
                        self.imu.yaw - self.start_pos.zero_south_degree
                    )
                    self.user_var.yaw_to_go = (
                        self.internal_operation_callback.abs_real(
                            (self.__calibrated_yaw - self.user_var.target_yaw)
                        )
                    )
                    self.output.rotation = (
                        (
                            self.user_var.rotation_direction
                            * self.user_var.base_rotation
                        )
                        * 3
                    ) * ((self.user_var.yaw_to_go / 100))
                    self.internal_operation_callback.debug_real(
                        "Yaw we have to still rotate", self.user_var.yaw_to_go
                    )
                transitioned_after = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_react(
                    transitioned_before
                )
    ...
    def __main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_left_react(
        self, transitioned_before
    ):
    ...
    def __main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_around_react(
        self, transitioned_before
    ):
    ...
    def __main_region_test_drive_main_r1_calibration_r1_waiting_react(
        self, transitioned_before
    ):
        """Implementation of __main_region_test_drive_main_r1_calibration_r1_waiting_react function."""
        # The reactions of state waiting.
        transitioned_after = transitioned_before
        if not self.__do_completion:
            if transitioned_after < 0:
                if not self.start_pos.set_zero:
                    self.__exit_sequence_main_region_test_drive_main_r1_calibration_r1_waiting()
                    self.__enter_sequence_main_region_test_drive_main_r1_calibration_r1_finished_calibration_default()
                    self.__main_region_test_drive_main_r1_calibration_react(0)
                    transitioned_after = 0
                elif self.__time_events[0]:
                    self.__exit_sequence_main_region_test_drive_main_r1_calibration_r1_waiting()
                    self.__time_events[0] = False
                    self.__enter_sequence_main_region_test_drive_main_r1_calibration_r1_waiting_default()
                    self.__main_region_test_drive_main_r1_calibration_react(0)
                    transitioned_after = 0
            # If no transition was taken
            if transitioned_after == transitioned_before:
                # then execute local reactions.
                transitioned_after = (
                    self.__main_region_test_drive_main_r1_calibration_react(
                        transitioned_before
                    )
                )
        return transitioned_after

    def __main_region_test_logging_grid_record_react(
        self, transitioned_before
    ):
        ...
        if (
            ...
            # Always execute local reactions.
            transitioned_after = self.__main_region_test_react(
                transitioned_before
            )
        return transitioned_after

    def __main_region_test_logging_grid_record_r1_start_record_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            ...
            if transitioned_after == transitioned_before:
                # then execute local reactions.
                transitioned_after = (
                    self.__main_region_test_logging_grid_record_react(
                        transitioned_before
                    )
                )
        return transitioned_after

    def __main_region_test_logging_grid_record_r1__final__react(
        self, transitioned_before
    ):
        """Implementation of __main_region_test_logging_grid_record_r1__final__react function."""
        # The reactions of state null.
        return self.__main_region_test_logging_grid_record_react(
            transitioned_before
        )

    def __main_region_test_logging_grid_check_status_react(
        self, transitioned_before
    ):
        ...
        if not self.__do_completion:
            ...
            if transitioned_after == transitioned_before:
                ...
                if self.__time_events[8]:
                    self.grid.column = (
                        self.internal_operation_callback.grid_position_column(
                            self.odom.x
                        )
                    )
                    self.grid.row = (
                        self.internal_operation_callback.grid_position_row(
                            self.odom.y
                        )
                    )
                    self.grid.receive = True
                    self.__distance_to_center = self.internal_operation_callback.distance_to_grid_center(
                        self.odom.x, self.odom.y
                    )
                    self.internal_operation_callback.debug_real(
                        "Distance to center box", self.__distance_to_center
                    )
                    self.internal_operation_callback.debug_bool(
                        "is grid visited", self.grid.visited
                    )
                transitioned_after = self.__main_region_test_react(
                    transitioned_before
                )
        ...
        if not self.__do_completion:
            ...
            if transitioned_after == transitioned_before:
                ...
                if self.__time_events[2]:
                    ...
                    self.grid.orientation = int(
                        self.internal_operation_callback.calc_orientation(
                            self.imu.yaw
                        )
                    )
                    self.grid.receive = True
                    ...
                    self.internal_operation_callback.debug_coord(
                        "Current location: ", self.grid.column, self.grid.row
                    )
                    self.internal_operation_callback.debug_coord(
                        "Odom:", self.odom.x, self.odom.y
                    )
                    self.internal_operation_callback.debug_real(
                        "orientation", self.grid.orientation
                    )
                    self.internal_operation_callback.debug_real(
                        "distance_to_center", self.__distance_to_center
                    )
                    self.internal_operation_callback.debug_bool(
                        "is grid visited", self.grid.visited
                    )
    ...
    def __main_region_test_logging_grid_initial_react(
        self, transitioned_before
    ):
        """Implementation of __main_region_test_logging_grid_initial_react function."""
        # The reactions of state initial.
        transitioned_after = transitioned_before
        if not self.__do_completion:
            if transitioned_after < 1:
                if self.has_calibrated:
                    self.__exit_sequence_main_region_test_logging_grid_initial()
                    self.__enter_sequence_main_region_test_logging_grid_check_status_default()
                    self.__main_region_test_react(0)
                    transitioned_after = 1
            # If no transition was taken
    ...
    def __micro_step(self):
        ...
        if state == self.State.main_region_test_drive_main_r1stopped:
            transitioned = self.__main_region_test_drive_main_r1_stopped_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_manual_r1_speed_r1_increase_speed_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_manual_r1_speed_r1_decrease_speed_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_right_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_manual_r1_rotations_r1_incr__rot__speed_left_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_calibrate_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_finished_calibration_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_right_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_forward_stop_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_stop_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turning_to_target_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_left_react(
                transitioned
            )
        elif (
            state
            ...
            transitioned = self.__main_region_test_drive_main_r1_automatic_mode_automatic_algorithm_follow_left_r1_turn_around_react(
                transitioned
            )
        if self.__state_conf_vector_position < 1:
            ...
            if (
                ...
                self.__main_region_test_logging_grid_record_r1_start_record_react(
                    transitioned
                )
            elif (
                state
                ...
                self.__main_region_test_logging_grid_record_r1__final__react(
                    transitioned
                )
            elif (
                state == self.State.main_region_test_logging_grid_check_status
            ):
                self.__main_region_test_logging_grid_check_status_react(
                    transitioned
                )
            elif state == self.State.main_region_test_logging_grid_start:
