...
class Model:
	...
	class State:
		...
		(
			...
			main_region_auto,
			main_region_auto_r1forward,
			main_region_auto_r1turn_right,
			main_region_auto_r1forward_stop,
			main_region_auto_r1turn_stop,
			null_state
		) = range(14)
	...
	def is_state_active(self, state):
		...
		if s == self.__State.main_region_auto:
			return (self.__state_vector[0] >= self.__State.main_region_auto)\
				and (self.__state_vector[0] <= self.__State.main_region_auto_r1turn_stop)
		if s == self.__State.main_region_auto_r1forward:
			return self.__state_vector[0] == self.__State.main_region_auto_r1forward
		if s == self.__State.main_region_auto_r1turn_right:
			return self.__state_vector[0] == self.__State.main_region_auto_r1turn_right
		if s == self.__State.main_region_auto_r1forward_stop:
			return self.__state_vector[0] == self.__State.main_region_auto_r1forward_stop
		if s == self.__State.main_region_auto_r1turn_stop:
			return self.__state_vector[0] == self.__State.main_region_auto_r1turn_stop
		return False
	...
	def __entry_action_main_region_auto_r1_forward(self):
	...
	def __entry_action_main_region_auto_r1_turn_stop(self):
	...
	def __enter_sequence_main_region_auto_default(self):
		"""'default' enter sequence for state auto.
		"""
		#'default' enter sequence for state auto
		self.__enter_sequence_main_region_auto_r1_default()
		
	def __enter_sequence_main_region_auto_r1_forward_default(self):
		"""'default' enter sequence for state Forward.
		"""
		#'default' enter sequence for state Forward
		self.__entry_action_main_region_auto_r1_forward()
		self.__state_vector[0] = self.State.main_region_auto_r1forward
		self.__state_conf_vector_changed = True
		
	def __enter_sequence_main_region_auto_r1_turn_right_default(self):
		"""'default' enter sequence for state Turn Right.
		"""
		#'default' enter sequence for state Turn Right
		self.__entry_action_main_region_auto_r1_turn_right()
		self.__state_vector[0] = self.State.main_region_auto_r1turn_right
		self.__state_conf_vector_changed = True
		
	def __enter_sequence_main_region_auto_r1_forward_stop_default(self):
		"""'default' enter sequence for state ForwardStop.
		"""
		#'default' enter sequence for state ForwardStop
		self.__entry_action_main_region_auto_r1_forward_stop()
		self.__state_vector[0] = self.State.main_region_auto_r1forward_stop
		self.__state_conf_vector_changed = True
		
	def __enter_sequence_main_region_auto_r1_turn_stop_default(self):
		"""'default' enter sequence for state TurnStop.
		"""
		#'default' enter sequence for state TurnStop
		self.__entry_action_main_region_auto_r1_turn_stop()
		self.__state_vector[0] = self.State.main_region_auto_r1turn_stop
		self.__state_conf_vector_changed = True
	...
	def __enter_sequence_main_region_auto_r1_default(self):
		"""'default' enter sequence for region r1.
		"""
		#'default' enter sequence for region r1
		self.__react_main_region_auto_r1__entry_default()
	...
	def __exit_sequence_main_region_auto(self):
		"""Default exit sequence for state auto.
		"""
		#Default exit sequence for state auto
		self.__exit_sequence_main_region_auto_r1()
		self.__state_vector[0] = self.State.null_state
		
	def __exit_sequence_main_region_auto_r1_forward(self):
		"""Default exit sequence for state Forward.
		"""
		#Default exit sequence for state Forward
		self.__state_vector[0] = self.State.main_region_auto
		
	def __exit_sequence_main_region_auto_r1_turn_right(self):
		"""Default exit sequence for state Turn Right.
		"""
		#Default exit sequence for state Turn Right
		self.__state_vector[0] = self.State.main_region_auto
		
	def __exit_sequence_main_region_auto_r1_forward_stop(self):
		"""Default exit sequence for state ForwardStop.
		"""
		#Default exit sequence for state ForwardStop
		self.__state_vector[0] = self.State.main_region_auto
		
	def __exit_sequence_main_region_auto_r1_turn_stop(self):
	...
	def __exit_sequence_main_region(self):
		...
		elif state == self.State.main_region_auto:
			self.__exit_sequence_main_region_auto()
		elif state == self.State.main_region_auto_r1forward:
			self.__exit_sequence_main_region_auto_r1_forward()
		elif state == self.State.main_region_auto_r1turn_right:
			self.__exit_sequence_main_region_auto_r1_turn_right()
		elif state == self.State.main_region_auto_r1forward_stop:
			self.__exit_sequence_main_region_auto_r1_forward_stop()
		elif state == self.State.main_region_auto_r1turn_stop:
			self.__exit_sequence_main_region_auto_r1_turn_stop()
	...
	def __exit_sequence_main_region_auto_r1(self):
		"""Default exit sequence for region r1.
		"""
		#Default exit sequence for region r1
		state = self.__state_vector[0]
		if state == self.State.main_region_auto_r1forward:
			self.__exit_sequence_main_region_auto_r1_forward()
		elif state == self.State.main_region_auto_r1turn_right:
			self.__exit_sequence_main_region_auto_r1_turn_right()
		elif state == self.State.main_region_auto_r1forward_stop:
	...
	def __react_main_region_auto_r1__entry_default(self):
		"""Default react sequence for initial entry .
		"""
		#Default react sequence for initial entry 
		self.__enter_sequence_main_region_auto_r1_forward_default()
	...
	def __main_region_stopped_react(self, transitioned_before):
		...
		if transitioned_after < 0:
			if self.computer.w_press:
				...
				self.__exit_sequence_main_region_stopped()
				self.__enter_sequence_main_region_auto_default()
				self.__react(0)
				transitioned_after = 0
	...
	def __main_region_auto_react(self, transitioned_before):
		"""Implementation of __main_region_auto_react function.
		"""
	...
	def __main_region_auto_r1_forward_react(self, transitioned_before):
		"""Implementation of __main_region_auto_r1_forward_react function.
		"""
		...
		if transitioned_after < 0:
			if self.laser_distance.dfront_mean <= self.user_var.min_wall_turn:
				self.__exit_sequence_main_region_auto_r1_forward()
				self.__enter_sequence_main_region_auto_r1_forward_stop_default()
				self.__main_region_auto_react(0)
				transitioned_after = 0
		#If no transition was taken
		if transitioned_after == transitioned_before:
			#then execute local reactions.
			transitioned_after = self.__main_region_auto_react(transitioned_before)
		return transitioned_after
	
	
	def __main_region_auto_r1_turn_right_react(self, transitioned_before):
		"""Implementation of __main_region_auto_r1_turn_right_react function.
		"""
	...
	def __main_region_auto_r1_forward_stop_react(self, transitioned_before):
		"""Implementation of __main_region_auto_r1_forward_stop_react function.
		"""
		#The reactions of state ForwardStop.
		transitioned_after = transitioned_before
		if transitioned_after < 0:
			if self.laser_distance.dleft_mean <= 0.35:
				self.__exit_sequence_main_region_auto_r1_forward_stop()
				self.__enter_sequence_main_region_auto_r1_turn_right_default()
				self.__main_region_auto_react(0)
				transitioned_after = 0
	...
	def __main_region_auto_r1_turn_stop_react(self, transitioned_before):
		"""Implementation of __main_region_auto_r1_turn_stop_react function.
		"""
	...
	def __micro_step(self):
		...
		if state == self.State.main_region_stopped:
			...
			self.__main_region_auto_r1_forward_react(-1)
		elif state == self.State.main_region_auto_r1turn_right:
			self.__main_region_auto_r1_turn_right_react(-1)
		elif state == self.State.main_region_auto_r1forward_stop:
			self.__main_region_auto_r1_forward_stop_react(-1)
		elif state == self.State.main_region_auto_r1turn_stop:
			self.__main_region_auto_r1_turn_stop_react(-1)
